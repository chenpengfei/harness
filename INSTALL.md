...
| Phase 2 | E — 环境：创建 `.harness/environment/` 文档和 harness-env skill | `docs/install/phase-2-environment.md` |
...
| Phase 5 | F — 反馈：创建 Review 清单和复盘模板 | `docs/install/phase-5-feedback.md` |
